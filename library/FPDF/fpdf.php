...
class FPDF
{
	...
	function FPDF($orientation='P', $unit='mm', $format='A4')
	{
		...
		$this->ws=0;
		//Standard fonts
		$this->AddFont('FreeSans', '', '629662fe12e3983a9b6f793ce2ffecd0_freesans.php');
		$this->AddFont('FreeSans', 'B', '2838fb095536d44c8333a7d5c415c85a_freesansbold.php');
		$this->AddFont('FreeSans', 'I', '9523de81e0d797e634e09db2aa9472f8_freesansoblique.php');
		$this->AddFont('FreeSans', 'BI', '29008e2490e66ae8af7090b2c513da1b_freesansboldoblique.php');
		//Scale factor
		if($unit=='pt')
		$this->k=1;
		elseif($unit=='mm')
	...
	function Footer()
	{
		$this->SetY(-10);
		$this->SetFont('','',5);
		if ($this->PageNo()>1) $this->Cell(150,3,$this->document_name,0,0,'L');
		$this->Cell(0,3,'Strana '.$this->PageNo().'/{nb}',0,0,'R');
	}
